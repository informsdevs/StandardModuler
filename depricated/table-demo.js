...
window.addEventListener("DOMContentLoaded", async () => {
    ...
    const importBtn = new ImportButton();
    document.getElementById("import").innerHTML = importBtn.html();
    importBtn.postRender();
    ...
    const table = new Table(apiClient)
        ...
        .addTableButtons()
        .addConditionalCssClassToRow("Total", Condition.GreaterThan, 100, "red")
        .mount('#stonortable')
